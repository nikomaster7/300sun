...
- Hosted on **Vercel** at https://300sun.vercel.app (project `300sun`), connected to GitHub: every push to `main` publishes automatically. `vercel.json` points it at `site/`.
